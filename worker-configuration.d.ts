// Generated by Wrangler by running `wrangler types` (hash: 364ab5d566147bbc1cabecf59ffe7015)
// Runtime types generated with workerd@1.20250404.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OAUTH_KV: KVNamespace;
		STRAVA_CLIENT_ID: string;
		STRAVA_CLIENT_SECRET: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").StravaMCP>;
		AI: Ai;
	}
}
